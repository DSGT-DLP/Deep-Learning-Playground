...
def get_torch_object(element):
    ...
    """
    return eval(element) #takes in the string representation and returns the "instantiated object"

if __name__ == "__main__":
    print("starting")
    print(parse_user_architecture(["nn.Linear(in_features=50, out_features=10)", "nn.Conv2d(in_channels=3, out_channels=36, kernel_size=3, stride=2)"]))