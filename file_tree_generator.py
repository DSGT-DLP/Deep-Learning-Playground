...
# Content to ignore
ignored_directories = ['.next', 'node_modules', '.venv', '__pycache__', 'aws_rekognition_utils', 'aws_secrets_utils', 
                       'lambda_utils', 's3_utils', 'sqs_utils', 'dlp_logging', 'endpoints','firebase_helpers', 'tests', 'tmp']
ignored_files = []
