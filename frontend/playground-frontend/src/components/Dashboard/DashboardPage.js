...
const DashboardPage = () => {
  const class1 = { title: "Intro to Machine Learning", points: 100 };

  const class2 = { title: "Intro to Deep Learning", points: 33 };

  const class3 = { title: "Convolutional layers", points: 0 };
      ...
      <div id="learningBody">
        <div className="dashboard">
          ...
          {lessons.map((lesson, index) => {
            return <Dashboard info={lesson} key={index} />;
          })}
          ;
        </div>
      </div>
