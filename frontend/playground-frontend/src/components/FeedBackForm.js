        ...
        <div>
            ...
            >
                ...
                <p>
                    ...
                    complains! We'll get back to as soon as we can.
                </p>
                <form>
                    ...
                    {submitted == true &&
                        firstName.trim() == "" &&
                        recaptcha !== "" && <p>First Name cannot be blank</p>}
                    ...
                    {submitted == true &&
                        lastName.trim() == "" &&
                        recaptcha != "" && <p>Last Name cannot be blank</p>}
                    <EmailInput email={email} EmailInput={setEmail} />
                    {submitted == true &&
                        email.trim() == "" &&
                        recaptcha !== "" && <p>Email Cannot be blank</p>}
