...
const ImageParametersStep = ({
    ...
    return (
      <Stack spacing={3}>
        ...
        />
        <TransformsDnd control={control} errors={errors} invenName="Train Transform" />
        <TransformsDnd control={control} errors={errors} invenName="Test Transform" />
  ...
  const TransformInventoryComponent = ({
    id,
    value,
  }: {
    id: number;
